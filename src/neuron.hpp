...
public:
	 ...
	 * 
	 * @param The index of the buffer in which the spikes are read in the membrane equation
	 * 
	 ...
	 * @param The value transmitted by the neuron varies according to the source neuron which can be inhibitory, excitatory or external.
	 * 
